...
export const Hero: React.FC = () => {
  return (
    <section
      id="home"
      className="relative text-white border-b-2 border-slate-900 overflow-hidden bg-slate-950"
    >
      {/* Background Image: Tractor & Machinery in Field / Depot with High Contrast Overlay */}
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Layered Deep Slate & Orange-Tinged Industrial Gradients */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-8 text-left space-y-5">
            ...
            <h1
              id="hero-headline"
              className="font-industrial text-4xl sm:text-5xl lg:text-6xl font-black uppercase text-white leading-[1.05] tracking-tight"
            >
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              >
                <i className="fa-solid fa-phone text-sm mr-2 text-orange-400"></i>
                Call 087078 26228
              </a>
            </div>

            {/* Quick Micro Technical Specs Row */}
          ...
          {/* Right Visual Card: Ready-to-Install Inventory Status with Warehouse Preview */}
          <div className="lg:col-span-4">
            <div className="bg-slate-900 rounded-[4px] border border-slate-700 shadow-xl relative overflow-hidden">
              ...
              <div className="p-4 sm:p-5 space-y-2.5 text-xs">
                {/* Supported Tractor & Fleet Highlights */}
                <div className="bg-slate-950 p-2.5 rounded-[3px] border-l-3 border-orange-500">
                  <span className="text-[10px] uppercase tracking-wider text-orange-400 font-bold block mb-0.5 font-mono">
                    Tractor Spares in Stock:
                  </span>
                  <p className="text-slate-300 text-[11px] font-mono leading-tight">
                    Swaraj • Mahindra • Sonalika • Eicher • Kubota • Powertrac
                  </p>
                </div>

                <div className="bg-slate-950 p-2.5 rounded-[3px] border-l-3 border-slate-600">
                  <span className="text-[10px] uppercase tracking-wider text-slate-300 font-bold block mb-0.5 font-mono">
                    Commercial Vehicle Spares:
                  </span>
                  <p className="text-slate-300 text-[11px] font-mono leading-tight">
                    Mahindra Jeep • Bolero Pik-Up • Maxi Truck • Camper
                  </p>
                </div>

                <div className="bg-slate-950 p-2.5 rounded-[3px] border border-slate-800">
                  <span className="text-[10px] uppercase tracking-wider text-slate-400 font-bold block mb-0.5 font-mono">
                    Dispatch Coverage:
                  </span>
                  <p className="text-slate-300 text-[11px]">
                    Pan-India Road Transport, Bus Cargo & Express Logistics
                  </p>
                </div>
                ...
                <div className="pt-2">
                  <a
                    href="https://wa.me/918707826228?text=Hello%20Patel%20Tractor%20Parts,%20I%20need%20spares%20for%20my%20tractor/vehicle"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full inline-flex items-center justify-center bg-[#25d366] hover:bg-[#20bd5a] text-slate-950 font-bold text-xs py-2.5 px-3 rounded-[3px] transition-colors uppercase tracking-wider font-mono"
                  >
                    <i className="fa-brands fa-whatsapp text-sm mr-2"></i>
                    Send Part Photo / Inquire
                  </a>
                </div>
              </div>
            </div>
